...
<script>
    ...
    $(function () {
        ...
        $(document).on('click', '.create-invoice', function () {
            ajaxPost("<?php echo site_url('invoices/ajax/modal_create_invoice'); ?>", {}).done(function(response) {
                $('#modal-placeholder').html(response.html);
            });
        });

        $(document).on('click', '.create-quote', function () {
            ajaxPost("<?php echo site_url('quotes/ajax/modal_create_quote'); ?>", {}).done(function(response) {
                $('#modal-placeholder').html(response.html);
            });
        });
        ...
        $(document).on('click', '#btn_quote_to_invoice', function () {
            ...
            ajaxPost("<?php echo site_url('quotes/ajax/modal_quote_to_invoice'); ?>/" + quote_id, {}).done(function(response) {
                $('#modal-placeholder').html(response.html);
            });
        });
        ...
        $(document).on('click', '#btn_copy_invoice', function () {
            ...
            ajaxPost("<?php echo site_url('invoices/ajax/modal_copy_invoice'); ?>", {
        ...
        $(document).on('click', '#btn_create_credit', function () {
            var invoice_id = $(this).data('invoice-id');
            ajaxPost("<?php echo site_url('invoices/ajax/modal_create_credit'); ?>", {
                invoice_id: invoice_id
            }).done(function(response) {
                $('#modal-placeholder').html(response.html);
            });
        ...
        $(document).on('click', '#btn_copy_quote', function () {
            var quote_id = $(this).data('quote-id');
            var client_id = $(this).data('client-id');
            ajaxPost("<?php echo site_url('quotes/ajax/modal_copy_quote'); ?>", {
                quote_id: quote_id,
                client_id: client_id
            }).done(function(response) {
                $('#modal-placeholder').html(response.html);
        ...
        $(document).on('click', '.client-create-invoice', function () {
            var client_id = $(this).data('client-id');
            ajaxPost("<?php echo site_url('invoices/ajax/modal_create_invoice'); ?>", {
                client_id: client_id
            }).done(function(response) {
                $('#modal-placeholder').html(response.html);
            });
        ...
        $(document).on('click', '.client-create-quote', function () {
            var client_id = $(this).data('client-id');
            ajaxPost("<?php echo site_url('quotes/ajax/modal_create_quote'); ?>", {
                client_id: client_id
            }).done(function(response) {
                $('#modal-placeholder').html(response.html);
            });
        ...
        $(document).on('click', '.invoice-add-payment', function () {
            ...
            ajaxPost("<?php echo site_url('payments/ajax/modal_add_payment'); ?>", {
                invoice_id: invoice_id,
